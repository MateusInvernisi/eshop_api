const { getProdutosDB, addProdutoDB, deleteProdutoDB, getProdutoPorCodigoDB, updateProdutoDB  } = require('../usecases/produtoUseCases');
...
const ProdutoPorCodigo = async (request, response) => {
...
module.exports = {
    getProdutos, addProduto, deleteProduto, ProdutoPorCodigo, updateProduto
}